...
namespace ym2fym
{
    public class Packbits
    {
        ...
        * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
         ...
         **/
        //public static void unpackbits(File.IO.Stream.MemoryStream ino, byte[] outb)
        //{
        //    //		int i;		// input index
        //    int o;      // output index
        //    int b;      // RLE compression marker byte
                ...
                switch (state)
                {
                    ...
                    case LITERAL:
                        ...
                        else
                        {
                            ...
                            Array.Copy(inb, i, outb, o, runcount);
                            i += runcount;
                            o += runcount;
